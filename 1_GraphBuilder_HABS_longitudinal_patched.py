...
how to run withing sypder cmd windos
runfile('/mnt/newStor/paros/paros_WORK/ines/code/harmonized/graph_builder_with_normcog_feature_sets.py', wdir='/mnt/newStor/paros/paros_WORK/ines/code/harmonized')
"""
...
# =========================================================
COHORT_NAME = "HABS"   # "ADNI", "ADRC", "HABS", "AD_DECODE"
...
def parallel_build_graphs(
    ...
    for subject in subjects:
        ...
        global_feat = build_global_feature_tensor(row, feature_mode, feature_set).numpy()
