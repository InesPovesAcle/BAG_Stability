...
# USER INPUT
# =========================
COHORT_NAME = "ADRC"   # "HABS", "ADNI", "ADRC", "AD_DECODE"
SAVE_OUTPUTS = True
...
OUT_DIR_MAP = {
    "HABS": os.path.join(os.environ["WORK"], "ines/results/BrainAgePredictionHABS"),
    "ADNI": os.path.join(os.environ["WORK"], "ines/results/BrainAgePredictionADNI"),
    "ADRC": os.path.join(os.environ["WORK"], "ines/results/BrainAgePredictionADRC"),
    "AD_DECODE": os.path.join(os.environ["WORK"], "ines/results/BrainAgePredictionADDECODE"),
}

OUT_DIR = OUT_DIR_MAP[COHORT_NAME]
