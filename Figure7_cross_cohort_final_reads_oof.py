...
Patched for the May 2026 validation rerun: subject-level OOF biological
validation tables are read from validation_figures_oof/ rather than the
legacy validation_figures/ directory.
...
def validation_dir(results_root: Path, cohort: str, feature_set: str) -> Path:
    return results_root / RESULTS_DIR_MAP[cohort] / f"ablation_{feature_set}" / "validation_figures_oof"
