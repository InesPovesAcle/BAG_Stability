...
# Run ADNI-only strict longitudinal Figure 8.
...
LOG8="Figure8_ADNI_STRICT_$(date +%Y%m%d_%H%M%S).log"

echo "Launching ADNI-only strict Figure 8..."
...
echo "  find /mnt/newStor/paros/paros_WORK/ines/results/BrainAgeValidation_AllCohorts_BAGBiasCorr_OOFGlobal_BiologicalValidation/Figure8_ADNI_longitudinal_delta_cBAG_STRICT \\"
echo "    -type f \\"
echo "    -printf \"%TY-%Tm-%Td %TH:%TM %s %p\\n\" | sort"
